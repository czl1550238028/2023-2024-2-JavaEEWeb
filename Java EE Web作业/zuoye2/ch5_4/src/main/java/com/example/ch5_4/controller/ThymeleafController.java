package com.example.ch5_4.controller;
import java.util.ArrayList;
import java.util.List;

import com.example.ch5_4.model.Book;
import com.example.ch5_4.model.User;
...
public class ThymeleafController {
	...
	public String index(Model model) {
		...
		User user1=new User("lhx","123456","刘海霞",40);
		User user2=new User("admin","123456","admin",40);
