/*
 ...
 Source Server Version : 50096 (5.0.96-community-nt)
 Source Host           : localhost:3306
 Source Schema         : lib

 Target Server Type    : MySQL
 Target Server Version : 50096 (5.0.96-community-nt)
 File Encoding         : 65001

 Date: 13/06/2024 11:25:05
*/
...
-- ----------------------------
INSERT INTO `book_info` VALUES (10000001, '大雪中的山庄', '东野圭吾', '北京十月文艺出版社', '9787530216835', '东野圭吾长篇小说杰作，中文简体首次出版。 一出没有剧本的舞台剧，为什么能让七个演员赌上全部人生.东野圭吾就是有这样过人的本领，能从充满悬念的案子写出荡气回肠的情感，在极其周密曲折的同时写出人性的黑暗与美丽。 一家与外界隔绝的民宿里，七个演员被要求住满四天，接受导演的考验，但不断有人失踪。难道这并非正常排练，而是有人布下陷阱要杀他们。 那时候我开始喜欢上戏剧和音乐，《大雪中的山庄》一书的灵感就来源于此。我相信这次的诡计肯定会让人大吃一惊。', '中文', 36.00, '2017-07-23', 9, 13, 1);
...
INSERT INTO `book_info` VALUES (10000005, '11处特工皇妃', '潇湘冬儿', '江苏文艺出版社', '9787539943893', '《11处特工皇妃(套装上中下册)》内容简介：她是国安局军情十一处惊才绝艳的王牌军师——收集情报、策划部署、进不友好国家布置暗杀任务……她运筹帷幄之中，决胜于千里之外，堪称军情局大厦的定海神针。', '中文', 74.80, '2011-05-05', 7, 2, 0);
...
CREATE TABLE `lend_list`  (
  ...
  PRIMARY KEY USING BTREE (`sernum`)
) ENGINE = InnoDB AUTO_INCREMENT = 1000007 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of lend_list
-- ----------------------------
INSERT INTO `lend_list` VALUES (1000001, 50000010, 100000, '2023-12-05', '2024-06-11');
INSERT INTO `lend_list` VALUES (1000002, 10000001, 100000, '2023-10-11', '2024-06-12');
INSERT INTO `lend_list` VALUES (1000003, 10000003, 100000, '2023-11-22', NULL);
INSERT INTO `lend_list` VALUES (1000004, 10000010, 100003, '2024-06-10', '2024-06-10');
INSERT INTO `lend_list` VALUES (1000005, 50000007, 100003, '2024-06-10', '2024-06-10');
INSERT INTO `lend_list` VALUES (1000006, 10000007, 100000, '2024-06-12', NULL);
...
CREATE TABLE `reader_info`  (
  `reader_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '卡号',
...
-- ----------------------------
INSERT INTO `reader_info` VALUES (100000, '小明', '男', '2023-04-19', '浙江省杭州市', '12345678909');
INSERT INTO `reader_info` VALUES (100001, '小红', '女', '2024-06-07', '浙江省金华市', '12345678901');
INSERT INTO `reader_info` VALUES (100002, '小丽', '女', '2024-06-07', '浙江省绍兴市', '12345678901');
INSERT INTO `reader_info` VALUES (100003, '小张', '男', '2024-03-13', '浙江省杭州市', '12345678901');
INSERT INTO `reader_info` VALUES (100004, '小李', '男', '2024-01-25', '浙江省杭州市', '12345678901');
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('100000', '123456', 'user');
INSERT INTO `user` VALUES ('100001', '123456', 'user');
INSERT INTO `user` VALUES ('100002', '123456', 'user');
INSERT INTO `user` VALUES ('100003', '123456', 'user');
INSERT INTO `user` VALUES ('100004', '123456', 'user');
